...
describe('Route', () => {
  ...
  it("supports params for /articles/:id", () => {
    const created = Route.setPath("get", "/articles/:id")
      .setParams(t.Object({ name: t.String({}) }))
      .setHandle(() => { })
      .build();
  ...
  it("validates validate method for GET /articles", () => {
    const created = () => Route.setPath("unknown" as any, "/articles")
      .setHandle(() => { })
      .build();
  ...
  it("validates request data for POST /articles", () => {
    const created = Route.setPath("post", "/articles")
      .setRequestData(t.Object({
        title: t.String(),
    ...
    const success = () => created.__handle({ body: { title: "abc", description: "abcd" } } as any, response);
    const failure = () => created.__handle({ body: {} } as any, response);
  ...
  it("disallows to use Route.setRequestData with GET and OPTIONS method", () => {
    const get = () => Route.setPath("get", "/articles")
      .setRequestData(t.Object({
        title: t.String(),
        description: t.String(),
      }))
    ...
    const options = () => Route.setPath("options", "/articles")
      .setRequestData(t.Object({
        title: t.String(),
        description: t.String(),
      }))
